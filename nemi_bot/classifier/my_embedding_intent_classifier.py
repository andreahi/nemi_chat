...
class MyEmbeddingIntentClassifier(Component):
    ...
    def __init__(self,
        ...
        super(MyEmbeddingIntentClassifier, self).__init__(component_config)
    ...
    def load(cls,
        ...
        # type: (...) -> MyEmbeddingIntentClassifier
        ...
        if model_dir and meta.get("classifier_file"):
            ...
            return MyEmbeddingIntentClassifier(
            ...
            return MyEmbeddingIntentClassifier(component_config=meta)
